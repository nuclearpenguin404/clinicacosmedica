...
$pdf->SetHeaderData('',0, $doctorHeader, 'http://clinicacosmedica.com');
...
$str = array();
array_push($str,"<h2>List of Doctors</h2>");


$Q="SELECT * FROM doctors WHERE isActive='1' ORDER BY lastName";
$R=mysql_query($Q);
$doctorsNmb=mysql_num_rows($R);

if($doctorsNmb>0)
{

	array_push($str,"<h2>Active doctors</h2>");
	...
	array_push($str,"<td style=\"width:15%;\"><strong>Email</strong></td>");
	array_push($str,"<td style=\"width:20%;\"><strong>Address</strong></td></tr>");
		

	for($i=0;$i<$doctorsNmb;$i++)
	{
...
if($doctorsNmb>0)
{
	...
	array_push($str,"<h2>Inactive doctors</h2>");
	array_push($str,"<table border=\"1\" cellpadding=\"4\" cellspacing=\"0\" style=\"font-size:80%\">");
	array_push($str,"<tr><td style=\"width:15%;\"><strong>First Name</strong></td>");
	array_push($str,"<td style=\"width:15%;\"><strong>Last Name</strong></td>");
	array_push($str,"<td style=\"width:15%;\"><strong>Cell Phone</strong></td>");
